...
static const struct m10bmc_sdata pmcibmc_temp_tbl[] = {
	...
	{ 0x4f0, 0x4f4, 0x4f8, 0x0, 0x0, 500, "Columbiaville Die Temperature" },
	{ 0x4fc, 0x500, 0x504, 0x52c, 0x0, 500, "Board Temperature#2" },
	{ 0x508, 0x50c, 0x510, 0x52c, 0x0, 500, "Board Temperature#3" },
	{ 0x51c, 0x518, 0x51c, 0x52c, 0x0, 500, "Board Temperature#4" },
	{ 0x520, 0x524, 0x528, 0x52c, 0x0, 500, "Board Temperature#5" },
	{ 0x530, 0x534, 0x538, 0x52c, 0x0, 500, "Board Temperature#6" },
	...
	{ 0x5c4, 0x5c8, 0x5cc, 0x5c0, 0x0, 500, "FPGA E-Tile Temperature [Remote]" },
	{ 0x5d0, 0x5d4, 0x5d8, 0x5c0, 0x0, 500, "FPGA P-Tile Temperature [Remote]" },
	{ 0x5dc, 0x5e0, 0x5e4, 0x5c0, 0x0, 500, "FPGA Core Temperature [Remote]" },
	{ 0x5e8, 0x5ec, 0x5f0, 0x5c0, 0x0, 500, "FPGA Corner Temperature [Remote]" },
};

static const struct m10bmc_sdata pmcibmc_in_tbl[] = {
...
static const struct m10bmc_sdata pmcibmc_curr_tbl[] = {
...
static const struct m10bmc_hwmon_board_data pmcibmc_hwmon_bdata = {
	.tables = {
		[hwmon_temp] = pmcibmc_temp_tbl,
		[hwmon_in] = pmcibmc_in_tbl,
		[hwmon_curr] = pmcibmc_curr_tbl,
	},
...
static const struct platform_device_id intel_m10bmc_hwmon_ids[] = {
	...
	},
	{
		...
		.driver_data = (unsigned long)&pmcibmc_hwmon_bdata,
	},
	{ }
};
